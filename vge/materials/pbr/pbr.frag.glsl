...
void main() {
    ...
    // vec4 mrColor = texture(tx_metalRoughness, i_UV0);
    ...
    vec3 diffuseColor = (1.0 - metallic) * diffuseAlphaColor.rgb;
    vec3 f0 = 0.16 * reflectance * reflectance * (1.0 - metallic) + diffuseAlphaColor.rgb * metallic;
