...
func loadLib() (err error) {
	...
	libcall.t_NewDepthRenderPass, err = dldyn.GetProcAddress(libcall.h_lib, "NewDepthRenderPass")
	if err != nil {
		return err
	}
	...
	libcall.t_RenderPass_Init, err = dldyn.GetProcAddress(libcall.h_lib, "RenderPass_Init")
	if err != nil {
		return err
	}
...
func call_Command_CopyBufferToImage(ctx APIContext, cmd hCommand, src hBuffer, dst hImage, imRange *ImageRange, offset uint64) {
	...
	rc := dldyn.Invoke6(libcall.t_Command_CopyBufferToImage, 5, uintptr(cmd), uintptr(src), uintptr(dst), uintptr(unsafe.Pointer(imRange)), uintptr(offset), 0)
	handleError(ctx, rc)
}
func call_Command_CopyImageToBuffer(ctx APIContext, cmd hCommand, src hImage, dst hBuffer, imRange *ImageRange, offset uint64) {
	...
	rc := dldyn.Invoke6(libcall.t_Command_CopyImageToBuffer, 5, uintptr(cmd), uintptr(src), uintptr(dst), uintptr(unsafe.Pointer(imRange)), uintptr(offset), 0)
	handleError(ctx, rc)
}
...
func call_Command_SetLayout(ctx APIContext, cmd hCommand, image hImage, imRange *ImageRange, newLayout ImageLayout) {
	...
	rc := dldyn.Invoke6(libcall.t_Command_SetLayout, 4, uintptr(cmd), uintptr(image), uintptr(unsafe.Pointer(imRange)), uintptr(newLayout), 0, 0)
	handleError(ctx, rc)
}
...
func call_Desktop_PullEvent(ctx APIContext, desktop hDesktop, ev *RawEvent) {
	...
	rc := dldyn.Invoke(libcall.t_Desktop_PullEvent, 2, uintptr(desktop), uintptr(unsafe.Pointer(ev)), 0)
	handleError(ctx, rc)
}
...
func call_Exception_GetError(ex hException, msg []byte, msgLen *int32) {
	_ = dldyn.Invoke6(libcall.t_Exception_GetError, 4, uintptr(ex), byteArrayToUintptr(msg), uintptr(len(msg)), uintptr(unsafe.Pointer(msgLen)), 0, 0)
}
...
func call_ImageLoader_Describe(ctx APIContext, loader hImageLoader, kind []byte, desc *ImageDescription, content []uint8) {
	...
	rc := dldyn.Invoke6(libcall.t_ImageLoader_Describe, 6, uintptr(loader), byteArrayToUintptr(kind), uintptr(len(kind)), uintptr(unsafe.Pointer(desc)), sliceToUintptr(content), uintptr(len(content)))
	handleError(ctx, rc)
}
...
func call_ImageLoader_Save(ctx APIContext, loader hImageLoader, kind []byte, desc *ImageDescription, buf hBuffer, content []uint8, reqSize *uint64) {
	...
	rc := dldyn.Invoke9(libcall.t_ImageLoader_Save, 8, uintptr(loader), byteArrayToUintptr(kind), uintptr(len(kind)), uintptr(unsafe.Pointer(desc)), uintptr(buf), sliceToUintptr(content), uintptr(len(content)), uintptr(unsafe.Pointer(reqSize)), 0)
	handleError(ctx, rc)
}
func call_ImageLoader_Supported(ctx APIContext, loader hImageLoader, kind []byte, read *bool, write *bool) {
	...
	rc := dldyn.Invoke6(libcall.t_ImageLoader_Supported, 5, uintptr(loader), byteArrayToUintptr(kind), uintptr(len(kind)), uintptr(unsafe.Pointer(read)), uintptr(unsafe.Pointer(write)), 0)
	handleError(ctx, rc)
}
...
func call_Instance_GetPhysicalDevice(ctx APIContext, instance hInstance, index int32, info *DeviceInfo) {
	...
	rc := dldyn.Invoke(libcall.t_Instance_GetPhysicalDevice, 3, uintptr(instance), uintptr(index), uintptr(unsafe.Pointer(info)))
	handleError(ctx, rc)
}
...
func call_MemoryBlock_Reserve(ctx APIContext, memBlock hMemoryBlock, memObject hMemoryObject, suitable *bool) {
	...
	rc := dldyn.Invoke(libcall.t_MemoryBlock_Reserve, 3, uintptr(memBlock), uintptr(memObject), uintptr(unsafe.Pointer(suitable)))
	handleError(ctx, rc)
}
...
func call_NewDepthRenderPass(ctx APIContext, dev hDevice, finalLayout ImageLayout, depthImageFormat Format, rp *hRenderPass) {
	...
	rc := dldyn.Invoke6(libcall.t_NewDepthRenderPass, 4, uintptr(dev), uintptr(finalLayout), uintptr(depthImageFormat), uintptr(unsafe.Pointer(rp)), 0, 0)
	handleError(ctx, rc)
}
...
func call_NewForwardRenderPass(ctx APIContext, dev hDevice, finalLayout ImageLayout, mainImageFormat Format, depthImageFormat Format, rp *hRenderPass) {
	...
	rc := dldyn.Invoke6(libcall.t_NewForwardRenderPass, 5, uintptr(dev), uintptr(finalLayout), uintptr(mainImageFormat), uintptr(depthImageFormat), uintptr(unsafe.Pointer(rp)), 0)
	handleError(ctx, rc)
}
...
func call_RenderPass_Init(ctx APIContext, rp hRenderPass) {
	...
	rc := dldyn.Invoke(libcall.t_RenderPass_Init, 1, uintptr(rp), 0, 0)
	handleError(ctx, rc)
}
